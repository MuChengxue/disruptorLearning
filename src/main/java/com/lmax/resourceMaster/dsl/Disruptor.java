...
import com.lmax.resourceMaster.*;
...
public class Disruptor<T>
{
    ...
    /**
     * Create a new Disruptor. Will default to {@link com.lmax.resourceMaster.BlockingWaitStrategy} and
     ...
     *
     * @param handlers the event handlers, previously set up with {@link #handleEventsWith(com.lmax.resourceMaster.EventHandler[])},
     ...
     *
     * @param processors the event processors, previously set up with {@link #handleEventsWith(com.lmax.resourceMaster.EventProcessor...)},
     *                   that will form the barrier for subsequent handlers or processors.
     * @return an {@link EventHandlerGroup} that can be used to setup a {@link SequenceBarrier} over the specified event processors.
     * @see #after(com.lmax.resourceMaster.EventHandler[])
     */
    ...
    /**
     * Calls {@link com.lmax.resourceMaster.EventProcessor#halt()} on all of the event processors created via this disruptor.
     */
    public void halt()
    {
        for (final ConsumerInfo consumerInfo : consumerRepository)
     ...
     * @see com.lmax.resourceMaster.Sequencer#getBufferSize()
     */
