...
import com.lmax.resource_master.*;
...
public class Disruptor<T>
{
    ...
    /**
     * Create a new Disruptor. Will default to {@link com.lmax.resource_master.BlockingWaitStrategy} and
     ...
     *
     * @param handlers the event handlers, previously set up with {@link #handleEventsWith(com.lmax.resource_master.EventHandler[])},
     ...
     *
     * @param processors the event processors, previously set up with {@link #handleEventsWith(com.lmax.resource_master.EventProcessor...)},
     *                   that will form the barrier for subsequent handlers or processors.
     * @return an {@link EventHandlerGroup} that can be used to setup a {@link SequenceBarrier} over the specified event processors.
     * @see #after(com.lmax.resource_master.EventHandler[])
     */
    ...
    /**
     * Calls {@link com.lmax.resource_master.EventProcessor#halt()} on all of the event processors created via this disruptor.
     */
    public void halt()
    {
        for (final ConsumerInfo consumerInfo : consumerRepository)
     ...
     * @see com.lmax.resource_master.Sequencer#getBufferSize()
     */
